...
#define SENSOR_PRIORITY_U_STAIR 4
...
#define EEPROM_U_STAIR_CALIBRATION_START 210
#define EEPROM_ADDR_U_STAIR_MASTER_START_L (EEPROM_U_STAIR_CALIBRATION_START)
#define EEPROM_ADDR_U_STAIR_MASTER_START_H (EEPROM_U_STAIR_CALIBRATION_START + 1)
#define EEPROM_ADDR_U_STAIR_MASTER_END_L (EEPROM_U_STAIR_CALIBRATION_START + 2)
#define EEPROM_ADDR_U_STAIR_MASTER_END_H (EEPROM_U_STAIR_CALIBRATION_START + 3)
#define EEPROM_ADDR_U_STAIR_SLAVE_START_L (EEPROM_U_STAIR_CALIBRATION_START + 4)
#define EEPROM_ADDR_U_STAIR_SLAVE_START_H (EEPROM_U_STAIR_CALIBRATION_START + 5)
#define EEPROM_ADDR_U_STAIR_SLAVE_END_L (EEPROM_U_STAIR_CALIBRATION_START + 6)
#define EEPROM_ADDR_U_STAIR_SLAVE_END_H (EEPROM_U_STAIR_CALIBRATION_START + 7)
